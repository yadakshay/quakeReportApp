...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link eqevent} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<eqevent> extractEarthquakes() {
        ...
        try {
            ...
            for (int i=0; i <= featuresArray.length(); i++)
            {
                ...
                earthquakes.add(new eqevent(magnitude, place, time, urlLink));
            }
